...
namespace Proyecto_Csharp.Clases
{
    class Empleado:Ifunciones
    {
        ...
        //Constructor para registar
        public Empleado(string _apellidos, string _nombre, string _cedula,
            string _genero, string _estado_civil, string _direccion, string _distrito_id
            )
        ...
        public Empleado(string _apellidos, string _nombre, string _cedula,
            string _genero, string _estado_civil, string _direccion, string _distrito_id, int _empleado_id
            )
        ...
        {
            var tabla = this.BuscarEmpleadoNombre(nombre);
